...
export const moviesData = [
  ...
  },
  {
    ...
    poster: '/images/4u7dg02wjiewmyum.jpg',
  ...
  },
  {
    ...
    poster: 'images/top-gun-maverick-alias-top-gun-2-cartel-de-los-personajes-de-ee-uu-tom-cruise-2022-paramount-pictures-cortesia-everett-collection-2j8ww6y.jpg',
  ...
  },
  {
    movieId: 'M006',
    title: 'Black Widow',
    description: 'Natasha Romanoff đối mặt với những bí mật đen tối từ quá khứ khi một âm mưu nguy hiểm liên quan đến lịch sử của cô xuất hiện. Đây là câu chuyện độc lập về siêu nữ anh hùng Black Widow.',
    duration: 134,
