        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Hệ thống rạp chiếu phim hiện đại với công nghệ tiên tiến, mang đến cho bạn những trải nghiệm xem phim đỉnh cao.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/combos" className="text-gray-300 hover:text-white transition-colors">
                  Combo bắp nước
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">1900 6017</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-purple-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-300">info@cinemahome.vn</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-purple-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
